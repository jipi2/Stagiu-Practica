...
1->2 := 
		...
		cat ./- (asa se pot deschide fisierele cu -)
...
11->12 := 
		  ...
		  cat data.txt | tr "[a-m][A-M][n-z][N-Z]" "[n-z][N-Z][a-m][A-M]"
		  5Te8Y4drgCRfCx8ugdwuEX8KFC6k2EUu

12->13 := 

		  am tot dezarhivat pana am ajuns la rezultat
		  comenzi folosite:
	      1. gunzip <Nume_Fis>
          2. bunzip2 <Nume_Fis>
          3. tar xf <Nume_Fis>		 
...
14->15 := 
		  ...
		  nc localhost 30000 (dupa am introdus parola de mai sus)e
...
16->17 := 
          ...
          nmap -p 31000-32000 localhost (asa am vazut ce porturi sunt activa si care nu sunt active)
...
19->20 := 
		...
		./bandit20-do cat /etc/bandit_pass/bandit20 (ne folosim de acel executabil pentru a executa comenzi cu drepturile ownerului care a creat fisierul)
 	 	GbKksEFF4yrVs6il55v6gwY5aVje5f0j
	
20->21 :=  

		   (este nevoie de 2 terminale);
...
21->22 := 
		  ...
		  m-am uitat la: [Scheduling Tasks in Linux - The CRONTAB Command](https://www.youtube.com/watch?v=UlVqobmcPuM&ab_channel=OneByteAtATime) , [Cron Jobs For Beginners](https://www.youtube.com/watch?v=v952m13p-b4&t=56s&ab_channel=Linode).
...
25->26 := (trebuie sa micsoram terminalul pentru a se putea executa comanda "more")
